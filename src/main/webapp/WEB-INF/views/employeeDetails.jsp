				...
				<tr>
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-danger btn-sm"
							onclick="openDeleteModal('${employee.getEmail()}')">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<strong id="employeeEmail"></strong> ?
			</div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-5 shadow-lg border-0">
            ...
            <div class="modal-header bg-gradient-primary text-white py-3">
                <h5 class="modal-title" id="editModalLabel"><i class="fas fa-user-edit me-2"></i>Edit Employee</h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="editEmpName" name="name" class="form-control" placeholder="Enter name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="editEmpRole" name="role" class="form-control" placeholder="Enter role" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" id="editEmpEmail" name="email" class="form-control" placeholder="Enter email" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="editEmpPhone" name="phone" class="form-control" placeholder="10-digit number" required pattern="\d{10}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" id="editEmpPassword" name="password" class="form-control" placeholder="Enter new password">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="editEmpAge" name="age" class="form-control" min="18" max="70" placeholder="Enter age">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="btn-group" role="group" aria-label="Gender selection">
                                <input type="radio" class="btn-check" name="gender" id="editMale" value="Male" readonly>
                                <label class="btn btn-outline-primary" for="editMale">Male</label>

                                <input type="radio" class="btn-check" name="gender" id="editFemale" value="Female" readonly>
                                <label class="btn btn-outline-primary" for="editFemale">Female</label>

                                <input type="radio" class="btn-check" name="gender" id="editOther" value="Other" readonly>
                                <label class="btn btn-outline-primary" for="editOther">Other</label>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="editEmpAddress" name="address" class="form-control" rows="3" placeholder="Enter address"></textarea>
                        </div>
                    </div>

                    <!-- Modal Footer -->
                    <div class="mt-4 d-flex justify-content-end">
                        <button type="button" class="btn btn-outline-secondary me-2" data-bs-dismiss="modal"><i class="fas fa-times me-1"></i> Cancel</button>

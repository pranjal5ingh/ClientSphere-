...
<body>
	...
	<section class="hero">
		<div class="container">
			...
			<p>Manage customers, grow business, and streamline operations
				with ease.</p>
		...
		<div class="container">
			<div class="row g-4">
				<div class="col-md-4">
					<div class="card shadow-sm h-100">
						<div class="card-body">
							...
							<p>Track all your activities and insights in one place with
				...
				<div class="col-md-4">
					<div class="card shadow-sm h-100">
						<div class="card-body">
							<img src="https://img.icons8.com/color/96/000000/handshake.png"
								alt="Clients">
							<h5>Client Management</h5>
							<p>Manage your clients effectively with automated reminders
								and tracking.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="card shadow-sm h-100">
						<div class="card-body">
							<img src="https://img.icons8.com/color/96/000000/commercial.png"
								alt="Growth">
							<h5>Business Growth</h5>
							<p>Boost your growth with AI-driven insights and customer
								engagement tools.</p>
						</div>
					</div>
				</div>
	...
	<section class="py-5 bg-light" id="more">
		<div class="container">
			<div class="text-center mb-5">
				...
				<p class="text-muted">Explore additional features and services
					of our CRM Application.</p>
			</div>
				...
				<div class="col-md-3">
					<div class="card shadow-sm h-100 text-center border-0">
						<div class="card-body">
							...
							<p class="text-muted">Get tailored services to manage clients
				...
				<div class="col-md-3">
					<div class="card shadow-sm h-100 text-center border-0">
						<div class="card-body">
							...
							<p class="text-muted">We provide 24/7 customer support to
								assist you anytime.</p>
							<a href="#" class="btn btn-outline-danger btn-sm">Contact
								Support</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="card shadow-sm h-100 text-center border-0">
						<div class="card-body">
							...
							<p class="text-muted">Already a user? Login to access your
								dashboard quickly.</p>
				...
				<div class="col-md-3">
					<div class="card shadow-sm h-100 text-center border-0">
						<div class="card-body">
							...
							<p class="text-muted">New here? Register and start managing
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 mb-4">
					<h5 class="fw-bold">
						<i class="bi bi-building-fill me-2"></i> CRM App
					</h5>
					<p class="text-muted">A simple yet powerful CRM solution to
						manage customers, track growth, and streamline operations.</p>
				</div>
				...
				<div class="col-md-4 mb-4">
					...
					<p class="mb-0">
						<i class="bi bi-envelope-fill me-2"></i> support@crmapp.com
					</p>
				</div>
